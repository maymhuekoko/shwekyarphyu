    ...
    $('#item_list').change(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                    ...
                    // if(isowner == "Owner"){
                        $('#units_table').append($('<tr>')).append($('<td>').text(1)).append($('<td>').text("")).append($('<td>').text(value.unit_code)).append($('<td>').text(value.unit_name)).append($('<td>').append(inputstock)).append($('<td>').append(value.reorder_quantity)).append($('<td>').append($(button)));
                    // }
                    // else{
